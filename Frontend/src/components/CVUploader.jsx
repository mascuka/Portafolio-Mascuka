...
export default function CVUploader({ currentCV, onCVChange }) {
  ...
  return (
    <div className="w-full">
      <label className={`group flex items-center gap-4 p-3 rounded-2xl border-2 border-dashed transition-all cursor-pointer ${
        isDark 
        ...
        <input type="file" className="hidden" onChange={handleFile} accept=".pdf" />

...
export default function Footer() {
  ...
  return (
    <footer className="w-full mt-auto">
      <div
        className={`w-full py-6 xl:py-4 px-6 sm:px-10 md:px-12 transition-all duration-700 border-t ${
          isDark
      ...
      >
        <div className="max-w-[1800px] mx-auto flex flex-col xl:flex-row items-center justify-between gap-6 xl:gap-4 min-w-0">
          ...
          {/* BLOQUE CENTRAL — 1 SOLA LINEA, AUTO SCALE */}
          <div
            ref={containerRef}
          ...
          >
            <div
              ref={textRef}
              className={`flex items-center justify-center gap-1.5 sm:gap-3 whitespace-nowrap uppercase font-['Quicksand'] ${
            ...
            >
              <span>
                {lang === 'ES'
                  ? 'No detengas a quien se quiere ir'
              ...
              <div
                className={`flex-shrink-0 ${
                  isDark
                    ? 'text-[#0078C8] opacity-60'
                    : 'text-[#0078C8] opacity-80'
                }`}
              >
                <svg
              ...
              <span>
                {lang === 'ES'
                  ? 'no corras a quien acaba de llegar'
                  : "don't run to those who just arrived"}
              </span>
            </div>
          </div>

          {/* BLOQUE DERECHO — BOTÓN ORIGINAL */}
          <div className="xl:flex-1 flex justify-center xl:justify-end w-full">
            <button
              ...
              className={`group flex items-center gap-2.5 sm:gap-3 transition-all duration-300 ${
                isDark
                  ? 'hover:text-[#0078C8]'
                  : 'hover:text-[#0078C8] text-slate-900'
              }`}
            >
              <span
                className={`text-[8px] sm:text-[9px] font-['Quicksand'] font-bold uppercase tracking-[0.18em] sm:tracking-[0.2em] transition-all whitespace-nowrap ${
                  isDark
              ...
              <div
                className={`flex-shrink-0 flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 rounded-xl transition-all duration-500 ${
                  isDark

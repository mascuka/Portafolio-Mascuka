          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 pt-4 md:pl-[100px]">
            ...
            {data?.email && (
              <button onClick={() => setShowMailModal(true)} title="Enviar Correo" className={commonBtnClass}>
                ...
                <img src="https://upload.wikimedia.org/wikipedia/commons/7/7e/Gmail_icon_%282020%29.svg" alt="Gmail" className={`w-5 h-5 z-10 transition-all duration-300 ${isDark ? 'grayscale contrast-125 brightness-[1.4] opacity-70 group-hover:grayscale-0 group-hover:contrast-100 group-hover:brightness-100' : 'grayscale contrast-150 brightness-75 opacity-80 group-hover:grayscale-0 group-hover:contrast-100'}`} />
              </button>
            )}
              ...
              <a href={getDownloadUrl(cvUrl)} title="Descargar CV" className={`${commonBtnClass} hover:shadow-[0_0_25px_rgba(232,93,51,0.6)]`}>
                ...
                <div className="relative z-10 flex items-center justify-center">
                   <svg width="24" height="28" viewBox="0 0 24 28" fill="none">
                      <path d="M4 2C4 0.895 4.895 0 6 0H14L20 6V26C20 27.104 19.104 28 18 28H6C4.895 28 4 27.104 4 26V2Z" className={`transition-colors duration-300 ${isDark ? 'fill-white/60' : 'fill-slate-500'} group-hover:fill-white`} />
            ...
            {isAdmin && (
              <button onClick={() => setIsEditing(true)} title="Configurar Perfil" className={`w-11 h-11 flex items-center justify-center border transition-all duration-300 hover:scale-105 rounded-full ${isDark ? 'border-white/10 text-white/20 hover:border-[#00A3FF]/40 hover:text-[#00A3FF]' : 'border-slate-300 text-slate-400 hover:border-[#0078C8]/40 hover:text-[#0078C8]'}`}>
